...
from util import use_cuda, get_config, load_dict, cal_accuracy, load_map
#import globals
...
def evaluate_result_for_category_remove_ordinal(benchmark_file, test_re_fp, out_file):
...
if __name__ == "__main__":
    ...
    evaluate_result_for_category_remove_ordinal(benchmark_file, test_re_fp, test_re_category_file)
