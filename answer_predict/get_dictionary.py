...
def get_dictionary(answer_predict_path, subgraph_files):
    ...
    fp_entity_name = os.path.join(answer_predict_path, 'entity_name_map.pkl')
    fp_date = os.path.join(answer_predict_path, 'dates.txt')
    fp_relation = os.path.join(answer_predict_path, 'relations.txt')
    fp_trelation = os.path.join(answer_predict_path, 'trelations.txt')
    fp_word = os.path.join(answer_predict_path, 'words.txt')
    fp_statement = os.path.join(answer_predict_path, 'statements.txt')
    fp_category = os.path.join(answer_predict_path, 'categories.txt')
    fp_signal = os.path.join(answer_predict_path, 'signals.txt')
    fp_tempfact_pkl = os.path.join(answer_predict_path, 'tempfacts.pkl')
    fp_tempfact = os.path.join(answer_predict_path, 'tempfacts.txt')
