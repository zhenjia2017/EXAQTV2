...
def entity_emb(entity_file, date_file, entity_name_file, wiki2vec):
    ...
    entity_name = pickle.load(open(entity_name_file, 'rb'))
    reverse_entity2id = {}
    embedding_matrix = []
    in_entity = []
    no_in_entity = []
    ...
    for i in range(len(reverse_entity2id)):
        ...
        if entity_label in date2id:
            ...
            #in_date.append(entity_label)
        else:
            entity_emb[i_str] = average_ent_emb(entity_label,wiki2vec,no_in_entity)

        embedding_matrix.append(entity_emb[i_str])
    embedding_matrix = np.asarray(embedding_matrix)
    #print("entity not in embedding dic: ", "#".join(no_in_entity))
    #print("entity in date: ", str(len(in_date)))
    #print("entity in entity: ", str(len(in_entity)))
    #print("entity in statement: ", str(len(in_statement)))
...
#     print('Embedding...')
#     cfg = globals.config
#     graftnet_path = '/GW/qa2/work/exact/GRAFTNET/'
#     print('Get embedding word list....')
#     MODEL_FILE = '/GW/qa2/work/exact/wikipedia2vec/wikipedia2vec_trained'
#     wiki2vec = Wikipedia2Vec.load(MODEL_FILE)
#     ADD_ENT_MAX = 500
#     entity_dic = graftnet_path + '/data/' + "entities_v5c_multiseed_twohop" + "M" + str(ADD_ENT_MAX) + ".txt"
#     relation_dic = graftnet_path + '/data/' + "relations_v5c_multiseed_twohop" + "M" + str(ADD_ENT_MAX) + ".txt"
#     word_dic = graftnet_path + '/data/' + 'vocab_v5c_multiseed_twohop' + "M" + str(ADD_ENT_MAX) + ".txt"
#     date_dic = graftnet_path + '/data/' + "tem_entities_v5c_multiseed_twohop" + "M" + str(ADD_ENT_MAX) + ".txt"
#     trelation_dic = graftnet_path + '/data/' + "tem_relations_v5c_multiseed_twohop" + "M" + str(ADD_ENT_MAX) + ".txt"
#     entity_name_dic = graftnet_path + '/data/' + "entityname_v5c_multiseed_twohop" + "M" + str(ADD_ENT_MAX) + ".pkl"
#
#     relation_emb_file = graftnet_path + '/data/' + "relations_v5c_multiseed_twohop" + "M" + str(ADD_ENT_MAX) + '_emb_wiki2vec100d.npy'
#     vocab_emb_file = graftnet_path + '/data/' + 'vocab_v5c_multiseed_twohop' + "M" + str(ADD_ENT_MAX) + '_emb_wiki2vec100d.npy'
#     entity_emb_file = graftnet_path + '/data/' + "entities_v5c_multiseed_twohop" + "M" + str(ADD_ENT_MAX) + '_emb_wiki2vec100d.npy'
#
#     # relation encoding, get pretrained_relation_emb_file
#     relation_embeddings, relation_embedding_matrix = relation_emb(relation_dic, wiki2vec)
#     # question word encoding, get pretrained_word_embedding_file
#     print('Embedding Words....')
#     vocab_embeddings, vocab_embedding_matrix = word_emb(word_dic, wiki2vec)
#     print('Embedding Entities...')
#     entity_embeddings, entity_embedding_matrix = entity_emb(entity_dic, date_dic, entity_name_dic, wiki2vec)
